/* WAP to create a class Bank to use variables account number, account type, account holder name, account type, inital balance. Use 3 methodes getdata(), deposit(), withdraw()
to create menu driven program */
